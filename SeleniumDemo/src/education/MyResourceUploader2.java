...
import org.openqa.selenium.support.ui.Select;
	...
	public class MyResourceUploader2 {
	    public static WebDriver driver = null;
	  //定义文档存放的路径，如果没有请自己建，并放入你将要上传的支持的资源
		public static final String PATH = "C:\\Users\\Think\\Desktop\\苏州导入数据\\资源";
		//教育后台的地址，如果变动请自行修改
		public static final String URL = "http://192.168.11.136:8082/edu/index.html";
		//Chrome浏览器的driver地址，如果变动请自行修改
		public static final String chromeDriverPath =  "C:\\chromedriver.exe";
		//autoit脚本的地址，如果变动请自行修改
		public static final String autoItScriptPath =  "C:\\Upload.exe";
		//用户名
		public static final String USERNAME = "18611821498";
		//密码
		...
		public static final int longWaitTime = 4000;
		...
		public static void main(String[] args) {
		   ...
		   maxWindow();
			...
			waitForPageToLoad(shortWaitTime);
				...
				//调用autoit上传资源
				new MyResourceUploader2().handleUpload("", filePath);
				...
				Select file2 = new Select(driver.findElement(By.id("sourcelevel2"))) ;
		 	    ...
		 	    file2.selectByIndex(new Random().nextInt(file2Num-1)+1);
				waitForPageToLoad(shortWaitTime);
				...
				Select file3 = new Select(driver.findElement(By.id("sourcelevel3"))) ;
		 	    ...
		 	    file3.selectByIndex(new Random().nextInt(file3Num-1)+1);
