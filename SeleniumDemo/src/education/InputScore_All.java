...
public class InputScore_All {
	
	public static WebDriver driver = null;
	//教育后台地址，如果有改变请修改URL地址
	public static final String URL = "http://192.168.11.136:8080/edu/login.html";
	//用户名，如果有变动请修改
        ...
        for (int i = 0; i < gradeOptions.size(); i++) {
        	...
        	for (int j = 0; j < classOptions.size(); j++) {
        		...
        		for (int j2 = 0; j2 < subjectOptions.size(); j2++) {
					...
					waitForPageToLoad(500);
					//通过JS设置时间
					String js="document.getElementById('score_examDate').removeAttribute('readonly');document.getElementById('score_examDate').setAttribute('value','2011-01-08');";
